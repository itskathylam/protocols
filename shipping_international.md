...
- Write a customs letter; see my [example](files/shipping_box.png). The important part is to state that materials being shipped are for research purposes only and have no commercial value.
